...
def main():
    ...
    x = us_df[['Year']] # x var = Year (independant)
    y = us_df['Female_Graduation_Rate'] # y var = Female Grad Rate (dependant)
    ...
    plt.title("Linear Regression for Female USA Comp Sci Students' Graduation Rate")
    # Show the plot
    plt.show()
